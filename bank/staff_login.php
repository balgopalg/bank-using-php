...
<body>
    ...
    <main>
        <div class="table">
            ...
            <form class="form" action="staff_login.php" method="post">
    ...
    if($uname==$sname && $upass==$spass && $role=='employee'){
        session_start();
        $_SESSION["loggedin"] = true;
        $_SESSION["userId"] = $uname;  
        header("location: ./components/staff/employee_dashboard.php");
    }else if($uname==$sname && $upass==$spass && $role=='manager'){
        session_start();
        $_SESSION["loggedin"] = true;
        $_SESSION["userId"] = $uname;  
        header("location: ./components/staff/manager_dashboard.php");
    }else{
